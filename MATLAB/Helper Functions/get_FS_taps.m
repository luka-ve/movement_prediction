function [indices] = get_FS_taps(FS_data, sampling_rate)
...
min_touch_length = 5; % In milliseconds
indices = round(initcros(pulse_width > (min_touch_length / sampling_rate)) * sampling_rate);
